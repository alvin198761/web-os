...
//----
    ...
    console.log(assetsPath + "/static")
    shell.mkdir("-p", assetsPath + "/static");
    shell.mv(assetsPath + "/component", assetsPath + "/static");
    shell.mv(assetsPath + "/csslibs", assetsPath + "/static");
    shell.mv(assetsPath + "/img", assetsPath + "/static");
    shell.mv(assetsPath + "/jslib", assetsPath + "/static");
  })
})
